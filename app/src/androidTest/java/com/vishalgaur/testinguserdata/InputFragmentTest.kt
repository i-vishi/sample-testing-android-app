...
class InputFragmentTest {
	...
	@Test
	fun onSubmit_validAndCompleteForm_noErrorShowDetailActivity() {
		Intents.init()
	...
	private fun clickSubmitActivityButton() =
			onView(withId(R.id.input_submit_act_btn)).perform(scrollTo(), click())
}